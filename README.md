...
```bash
workspaces-custom-image-workflow$ sam build --use-container
```
...
```bash
workspaces-custom-image-workflow$ sam logs -n StockCheckerFunction --stack-name "workspaces-custom-image-workflow" --tail
```
...
```bash
workspaces-custom-image-workflow$ pip install -r tests/requirements.txt --user
# unit test
workspaces-custom-image-workflow$ python -m pytest tests/unit -v
# integration test, requiring deploying the stack first.
# Create the env variable AWS_SAM_STACK_NAME with the name of the stack we are testing
workspaces-custom-image-workflow$ AWS_SAM_STACK_NAME="workspaces-custom-image-workflow" python -m pytest tests/integration -v
```
...
```bash
sam delete --stack-name "workspaces-custom-image-workflow"
```
